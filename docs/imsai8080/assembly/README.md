...
| 2. | PSRAM (SMD) | `U13` front | Now start soldering the components to the main circuit board, starting with the two Surface Mount Device (SMD) components. These components will be soldered onto the **front** of the circuit board; the side without the IMSAI logo. If you have never soldered SMD components before, you're strongly encouraged to watch the video instructions first. *Note: Pin 1 is indicated on the PCB by a white dot and on the component by a dimple in the plastic case*. When done, perform a continuity test with a multimeter from each pin of the SOP-8 package to a connected pad on the PCB (see video, details to follow) |
...
- The black acrylic alignment tool with 8 round holes should always be used to help align 8 LEDs at a time to be in alignment. Peel any covered off the alignment tool before using it.
...
| 10b. | Resistor 3K ohm (x8) | `R40-R47` front | Black, Orange, Black, Gold |
| 11b. | Test Lead | [TEST STEP] | |
| 9c. | LED Red 5mm (x8) | `LO0-LO7` front | |
| 10c. | Resistor 3K ohm (x8) | `R16-R23` front | Black, Orange, Black, Gold |
| 11c. | Test Lead | [TEST STEP] | |
| 9d. | LED Red 5mm (x8) | `LA0-LA7` front | |
| 10d. | Resistor 3K ohm (x8) | `R24-R31` front | Black, Orange, Black, Gold |
| 11d. | Test Lead | [TEST STEP] | |
| 9e. | LED Red 5mm (x8) | `LD0-LD7` front | |
| 10e. | Resistor 3K ohm (x8) | `R52-R59` front | Black, Orange, Black, Gold |
| 11e. | Test Lead | [TEST STEP] | |
| 9f. | LED Red 5mm (x4) | `LHT1, LWT1, LRN1, LIE1` front | |
| 10f. | Resistor 3K ohm (x4) | `R48-R51` front | Black, Orange, Black, Gold |
...
| Step | Parts | Location | Notes |
| ---: | ----- | -------- | ----- |
| 12. | Resistor 10K ohm | `R1-R12` front | Resistors are **not** polarized and can be inserted & soldered either way around. Because of my sense of aesthetic (ok, my OCD) I like to orientate them all the same way according to the coloured bands. Brown, Black, Orange, Gold. |
